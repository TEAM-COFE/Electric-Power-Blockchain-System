...
class Transaction:
    ...
    def __init__(self, sender_address, sender_private_key, recipient_address,  value,  value_current,value_power,value_datatime,value_d):
...
def generate_transaction():
    ...
    print('\n\n value_d=',value_d)
    print('\n')
    transaction = Transaction(sender_address, sender_private_key, recipient_address,  value, value_current, value_power,value_datatime,value_d)
    print('\nbbbb')
