...
def mine():
    ...
    """
    print('\n\n @@@@@ def mine()')
    blockchain.submit_transaction(sender_address=MINING_SENDER, recipient_address=blockchain.node_id, value=MINING_REWARD, value_current=MINING_REWARD, value_power=MINING_REWARD, value_datatime=MINING_REWARD,value_d=MINING_SENDER,signature="")
